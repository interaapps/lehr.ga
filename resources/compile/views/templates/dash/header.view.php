...
<div id="main">
    ...
    <div id="behind_sidenav">
        <div id="mySidenav" class="sidenav">
            ...
            <a id="sidenav_personalinfo" href="/storage" title="My Files" class="{{($url=="/storage") ? "sidenavselected " : ""}}rippleeffect drawerbtn drawerbtn2 sidenava"><i  class="small material-icons-outlined sideicon">storage</i></a>
