...
<!-- <h2 id="className"></h2> -->
    ...
    <script>
        ...
        function loadPosts() {
            ...
            $("#classPosts").html("");
            Cajax.post("/course/<?php echo ($pageid); ?>").then(function (resp) {
                ...
                <?php if($isMine):?>
                    $("#classPosts").html("<br>"+ '<a href="/course/<?php echo ($pageid); ?>/new" class="flatButton2 waves-effect waves-light"><i class="material-icons">add</i><span>Add post</span></a><br><br>' + $("#classPosts").html());
                <?php endif; ?>
                $("#classPosts").html("<h1>"+parsedJSON.title+"</h1>"+$("#classPosts").html());
                $(".classPost").click(function () {
                    window.location = "/course/<?php echo ($pageid); ?>/post/" + $(this).attr("postId");
                });
            }).catch(function () {
        ...
        function loadPeople() {
            ...
            $("#addnewuser").click(function(){
                Cajax.post("/course/<?php echo ($pageid); ?>/people/add", {
