...
<head>
    ...
    <?php if( (isset($_COOKIE["darkmode"])) ? $_COOKIE["darkmode"] == "true" : false ):?>
...
<div id="nav" style="display: flex">
    <?php if( (isset($usingSidenav)) ? $usingSidenav : true ):?>
...
<div id="main">
    ...
    <div id="behind_sidenav">
        <div id="mySidenav" class="sidenav">
            <?php if( USER !== false ):?>
            <a id="sidenav_home" href="/" title="Homepage" class="<?php echo (($url=="/") ? "sidenavselected " : ""); ?>rippleeffect drawerbtn drawerbtn1 sidenava"><i class="small material-icons-outlined sideicon">home</i></a>

            <a id="sidenav_personalinfo" href="/courses" title="Courses" class="<?php echo (($url=="/courses") ? "sidenavselected " : ""); ?>rippleeffect drawerbtn drawerbtn2 sidenava"><i  class="small material-icons-outlined sideicon">school</i></a>
            
            <a id="sidenav_personalinfo" href="/user" title="Students" class="<?php echo (($url=="/user") ? "sidenavselected " : ""); ?>rippleeffect drawerbtn drawerbtn2 sidenava"><i  class="small material-icons-outlined sideicon">group</i></a>
